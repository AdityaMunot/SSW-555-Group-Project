...
for i in individual_list:
    table.add_row([i[0], i[1], i[2], i[3], calculate_age(i[3], i[4]), checkAlive(i[4]), i[4], i[6], i[5]])
print(table)
...
for i in family_list:
    table.add_row([i[0], i[3], i[4], i[1], Getname(individual_list, i[1]), i[2], Getname(individual_list, i[2]), i[5]])
print(table)
